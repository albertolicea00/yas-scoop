# 🥄 Yet Another Store for Scoop

> A modern, premium GUI wrapper for the **Scoop** (`scoop`) package manager.
...
**Yet Another Store for Scoop** brings all that CLI power into a stunning, native-feeling graphical user interface. No more forgotten commands, no more syntax errors. Just pure, visual package management.
...
- **Official Website/Repository**: [Scoop](https://scoop.sh)

## 🛠️ Requirements

- The `scoop` command-line tool must be installed on your system and available in your shell's `PATH`.
...
```bash
git clone https://github.com/albertolicea00/yas-scoop.git
cd yas-scoop
cmake --preset default        # configure (Ninja, Debug)
cmake --build --preset default
.\build\default\yas-scoop.exe
```
...
- 🐛 [Report a bug](https://github.com/albertolicea00/yas-scoop/issues/new?template=bug_report.md)
- 💡 [Request a feature](https://github.com/albertolicea00/yas-scoop/issues/new?template=feature_request.md)

## ⚖️ License & Legal

**Yet Another Store for Scoop** is released under the **[MIT License](LICENSE)**.
...
Third-party tools (primarily **Scoop**) are not bundled and governed by their own licenses.
